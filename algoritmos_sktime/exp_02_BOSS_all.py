...
data_path = '/home/temp/wzalewski/Patricia/DadosKepler/shallue_all_local.csv'
path_result = '/home/temp/wzalewski/Patricia/Resultados_Todos/Local/' + book_name + '.xlsx'
...
X_nested = from_2d_array_to_nested(X_norm)[:30]

#definição dos modelos e parametros
model_params = {
    'Individual_BOSS' : {
        'model': IndividualBOSS(),
        'params': {
            'random_state': [1],
...
resultados_completos.to_excel(writer, sheet_name=local + '_completo')
writer.save()
writer.close()
