...
data_path = '/home/temp/wzalewski/Patricia/DadosKepler/shallue_all_global.csv'
path_result = '/home/temp/wzalewski/Patricia/Resultados_Todos/Global/' + book_name + '.xlsx'
...
X_norm = norm_data.values[0:50] #tamanho limitado para testes rápidos

#label binário
lb = LabelBinarizer()
y = lb.fit_transform(label)
y = y.reshape(-1)[0:50]  #tamanho limitado para testes rápidos
